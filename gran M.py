# encoding=utf-8
import numpy as np  # operación de matriz de Python lib
class Simplex():
    ...
    def __init__(self):
        ...
        self._b = ""  #Formación
        self._c = ''  # Restricción
        self._B = ''  # Conjunto de subíndices de variable base
    ...
    def solve(self):
        ...
        self._A = np.array([[1,-1,1]])# Coeficiente de restricción de igualdad self._A, vector de columna de dimensión 3x1
        self._b = np.array([2])# Coeficiente de restricción de igualdad self._b, valor 1x1
    ...
    def InitializeSimplex(self, A, b):
        ...
        b_min, min_pos = (np.min(b), np.argmin(b))  # Consigue el bi más pequeño
